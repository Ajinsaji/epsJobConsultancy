          ...
          <div className="relative">
            ...
            <div className="mt-8 space-y-3">
              {['AI Assisted Recruitment', 'Trusted Companies', 'Secure Authentication'].map((t, idx) => (
                ...
                >
                  <span className="mt-0.5 inline-flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br from-[#0B4C8C]/30 to-[#CCA43B]/30 shadow-[0_0_25px_rgba(11,76,140,0.25)]">
              ...
              <div className="flex items-center justify-between gap-3 text-xs">
                <label className="flex items-center gap-2 select-none text-white/70">
                  <input
                    ...
                    className="h-4 w-4 accent-[#CCA43B]"
                  />
                  Remember me
                </label>

                <Link className="font-semibold text-[#CCA43B] hover:text-[#E5C56E] transition" to="/forgot-password">
                  Forgot Password
                </Link>
              </div>
