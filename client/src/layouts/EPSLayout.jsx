...
export default function EPSLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#111827] flex font-sans selection:bg-[#2563EB] selection:text-white">
      ...
      <EnterpriseSidebar portalType="admin" collapsed={collapsed} setCollapsed={setCollapsed} />
      ...
      <div className={`flex-1 flex flex-col min-w-0 transition-all duration-300 ${collapsed ? 'md:ml-20' : 'md:ml-64'}`}>
        ...
        {/* Topbar */}
        <EnterpriseTopbar 
          title="Super Admin Telemetry" 
          subtitle="System Health, Revenue & Enterprise Management" 
          onQuickAction={() => navigate('/eps/manage-jobs')}
        />
