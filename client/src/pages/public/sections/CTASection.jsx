...
export default function CTASection() {
  ...
  return (
    <section className="py-24 bg-[#050816] text-white relative overflow-hidden">
      {/* Glow backgrounds */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] rounded-full bg-gradient-to-r from-[#0B4C8C]/15 to-[#CCA43B]/10 blur-[140px] pointer-events-none" />

      <div className="mx-auto max-w-[1400px] px-6 relative z-10">
        
        {/* Banner card container */}
        <div className="rounded-[32px] border border-white/10 bg-gradient-to-br from-[#080E24]/90 via-[#030612]/90 to-[#080E24]/90 p-8 sm:p-12 lg:p-16 text-center space-y-8 shadow-[0_0_80px_rgba(11,76,140,0.15)] relative overflow-hidden">
